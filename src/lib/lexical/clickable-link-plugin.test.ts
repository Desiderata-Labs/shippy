  ...
  describe('Common URL Validation', () => {
    it('should allow common URLs', () => {
      const urls = [
        ...
        'https://www.nejm.org/doi/full/10.1056/NEJMoa123456',
        'mailto:patient.portal@hospital.org',
        'https://epic.hospital.org/mychart',
        'https://telemedicine.provider.net/virtual-visit',
      ]
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle URLs with query parameters and fragments', () => {
      const complexUrls = [
        ...
        'https://portal.hospital.org/login?redirect=/dashboard#overview',
        'mailto:doctor@clinic.org?subject=Patient%20Follow-up',
        'https://api.service.com/v1/patients?id=123&include=notes',
      ]
