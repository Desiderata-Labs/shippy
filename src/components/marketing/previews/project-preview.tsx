...
const ProjectPreviewComponent = () => {
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/25 px-6 pt-6">
      <div className="flex h-full w-full max-w-[360px] flex-col overflow-hidden rounded-t-[28px] rounded-b-none border border-border/40 bg-background/98 shadow-[0_24px_48px_rgba(15,23,42,0.12)] ring-1 ring-black/5">
        {/* Hero Banner */}
