/*
 * NanoID Functions for PostgreSQL
 * 
 * Based on code from Viascom Ltd liab. Co (Apache 2.0 License)
 * Generates compact, URL-friendly unique identifiers.
 */
...
CREATE OR REPLACE FUNCTION nanoid(
    size int DEFAULT 12, -- The number of symbols in the NanoId String. Must be greater than 0.
